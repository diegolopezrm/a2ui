...
- (v0_9) Enhance `GenericBinder` schema inference to recognize `$defs` descriptions, structural template component IDs (`id` / `componentId`), and provide runtime reactive fallback binding for static or unannotated schemas.
